...
<table>
    <tr style="font-weight: bold; background-color: <?php echo $color; ?>; color: #fff;  ">
        ...
        <th style="text-align: center;  width: 15%; border-right: 1px solid #eee;"> <?php echo 'VALOR VENDA'; ?></th>
    ...
    <?php foreach($categories as $key => $category): ?>
        <tr style="color: <?php echo $color; ?>;  ">
            ...
            <td style="text-align: center;  width: 15%; border-right: 1px solid #eee;"> <?php echo to_currency($categories_value[$key], 'R$'); ?></td>
    ...
    <tr style="background-color: <?php echo $secondary_color?>;">
        <td colspan="4" style="width: 15%; border-right: 1px solid #eee;"> <?php echo 'VALOR TOTAL'; ?></td>
...
<table>
    ...
    <?php foreach($categories_locacao as $key => $category): ?>
        <tr style="color: <?php echo $color; ?>;  ">
            ...
            <!-- <td style="text-align: center;  width: 15%; border-right: 1px solid #eee;"> <?php //echo to_currency($categories_value_locacao[$key], 'R$'); ?></td>
            <td style="text-align: center;  width: 15%; border-right: 1px solid #eee;"> <?php //echo to_currency($categories_value_total_locacao[$key], 'R$'); ?></td> -->
        </tr>
        <?php $contador_categorias++; ?>
    <?php endforeach; ?>
    <tr style="background-color: <?php echo $secondary_color?>;">
        <td colspan="5" style="width: 15%; border-right: 1px solid #eee;"> <?php echo 'VALOR TOTAL'; ?></td>
